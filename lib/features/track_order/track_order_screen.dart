...
import 'package:fruit_app/features/order_list_feature/widgets/item_widget.dart';

import '../../core/constants/app_colors.dart';
import '../../core/constants/app_text_styles.dart';
import '../order_list_feature/widgets/custom_pp_bar.dart';
      ...
      body: Padding(
       ...
       //   crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            ...
            SizedBox(height: 40,),
            DelivaryStatusItem(text: 'Order Taken',),
            DelivaryStatusItem(text: 'Order Is Being Prepared',),
             
            OrderDeliveredWidget(),SizedBox(height: 48,),
            DelivaryStatusItem(text: 'Order Received',),
          ],
        ),
      ),
    );
